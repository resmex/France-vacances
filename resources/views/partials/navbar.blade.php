...
<nav class="navbar navbar-expand-lg tt-navbar fixed-top">
	<div class="container">
		<a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
			...
			<span>France<span class="brand-accent">Vacances</span></span>
		</a>
		...
		<div class="collapse navbar-collapse" id="ttNav">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item">
					<a class="nav-link {{ request()->is('packages*') ? 'active' : '' }}" href="{{ route('packages') }}">Properties</a>
				</li>
				<li class="nav-item">
						...
						<ul class="dropdown-menu dropdown-menu-end shadow-sm border rounded-3 p-1">
							...
							<li>
								...
								<a class="dropdown-item rounded-2 py-2" href="{{ route('home') }}">
									<i class="fas fa-shield-halved me-2 text-muted"></i>Admin Dashboard
								</a>
							@else
								<a class="dropdown-item rounded-2 py-2" href="{{ route('account.dashboard') }}">
									<i class="fas fa-tachometer-alt me-2 text-muted"></i>My Account
								</a>
							@endif
							</li>
							<li>
								<a class="dropdown-item rounded-2 py-2" href="{{ route('account.profile') }}">
							...
							<li>
								<a class="dropdown-item rounded-2 py-2" href="{{ route('bookings.my') }}">
									<i class="fas fa-calendar-check me-2 text-muted"></i>My Bookings
								</a>
							</li>
							<li><hr class="dropdown-divider"></li>
							<li>
